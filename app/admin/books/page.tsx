  ...
  return (
    <div>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "28px" }}>
        <div>
          <h1 style={{ fontSize: "28px", fontWeight: 700, color: "#e8c87a", fontFamily: "Georgia, serif" }}>Gestion des livres</h1>
          <p style={{ color: "#6b6475", fontSize: "14px", marginTop: "4px" }}>{books.length} ouvrages au total</p>
        </div>
        <Link href="/admin/books/add" style={{
          padding: "10px 20px", background: "#c9a96e", color: "#0f1117",
        ...
        <table style={{ width: "100%", borderCollapse: "collapse" }}>
          <thead>
            <tr style={{ borderBottom: "1px solid #2a2540", background: "#13111e" }}>
              {["Couverture", "Titre & Auteur", "ISBN", "Copies", "Emprunts actifs", "Ajouté le", ""].map(h => (
                <th key={h} style={{ textAlign: "left", padding: "12px 16px", color: "#6b6475", fontWeight: 500, fontSize: "12px", textTransform: "uppercase", letterSpacing: "0.5px" }}>
                  {h}
                </th>
              ))}
            </tr>
